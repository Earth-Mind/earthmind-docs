...
Considering the EarthMind client contract is deployed in the Ethereum Blockchain and the EarthMind subnet is in the Bittensor Blockchain, there is a need to transfer decisions taken in the Bittensor side to Ethereum.

The Intelligence bridge enables a secure connection between the EarthMind subnet and the protocols implementing the EarthMind client contract in the Ethereum Blockchain. This connection is secured through an [EigenLayer AVS]. 
...
- **Blockchain Integrity:** All decisions and actions within the EarthMind network are securely recorded on the Bittensor Blockchain and in the Ethereum Blockchain, providing a transparent and immutable ledger.
