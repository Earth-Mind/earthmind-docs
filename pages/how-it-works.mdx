...
In order to understand how it works, let's analyze the full lifecycle of a `Governance request` from a Consumer protocol and learn how each component interacts with each other. The following image illustrates this process:
